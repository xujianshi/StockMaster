...
(function () {
    ...
    Object.extend(StockSuggest.prototype, {
            ...
            if (this._D != null && this._D != "") {
                switch (this._D[2]) {
                    ...
                    case "50":
                        ...
                        break;
                    default:
                        _u = "http://xinsanban.eastmoney.com/QuoteCenter/" + this._D[1] + ".html";
                        break
                }
                if (_u != "") {
                    var isEnter = false;
        ...
        ToDataPage: function () {
            ...
            var tempVal = this.input.value;
            //this.input.name = "";
            var _u = "http://data.eastmoney.com/stockdata/" + tempVal + ".html";
            var isSixNum = !isNaN(this.input.value) && this.input.value.length == 6;
            this.input.name = "from";
            this.input.value = "csj";

            if (!isSixNum) {
                this.input.name = "stockcode";
                _u = "http://data.eastmoney.com/center/";
            }
            this.goUrl(_u, "_blank", false);
            this.input.name = tmpInput;
            this.input.value = tempVal;
        },
        ...
        Tip: function () {
            ...
            if (("key_" + _s) in this._Y && this._Y["key_" + _s] != "") {
                ...
                _t_h_tr.style.cssText = "background:#E6F4F5;height:22px;line-height:22px;overflow:hidden;table-layout:fixed;";
                if (this.header != null) {
                    for (var i = 0; i < this.header.length; i++) {
                        var _t_th = Gee.$C("th");
                        if (this.header[i] == "选项") _t_th.width = 52;
                        if (this.header[i] == "代码") _t_th.width = 52;
                        if (this.header[i] == "类型") _t_th.width = 40;
                        if (this.header[i] == "名称") _t_th.width = 54;
